...
if (har_epler <= 0):
  ...
  if (gir_epler < har_epler / 2):
    ...
    if(har_epler - gir_epler == 1):
        print("Du har nå ett eple igjen.")
    elif(har_epler - gir_epler < 0):
        rest = abs(har_epler - gir_epler)
        if(rest == 1):
            print("Du har nå 0 epler igjen. Gi meg det ene du skylder meg neste gang vi møtes.")
        else:
            print("Du har nå 0 epler igjen. Gi meg de", rest,"du skylder meg neste gang vi møtes.")
    else:
